    ...
    protected void execute(String[] tokens, int depth) {
        ...
        if (tokens.length > 1) {
            ...
            if (tokens[1].equalsIgnoreCase("rnd")) {
                ...
                l = WordSpireInitializer.allBooks.get(b).lexicons.get(
                        MathUtils.random(WordSpireInitializer.allBooks.get(b).lexicons.size() - 1));
        ...
        if (tokens.length > 2) {
            ...
            if (tokens[2].equalsIgnoreCase("rnd")) {
                ...
                // 检查使用的 lexicon 是否合法
                if (!WordSpireInitializer.allBooks.get(b).lexicons.contains(l)) {
    ...
    protected ArrayList<String> extraOptions(String[] tokens, int depth) {
        ...
        switch (tokens.length) {
            ...
            case 3: {
                ...
                result.add("rnd");
                for (LexiconEnum l: WordSpireInitializer.allBooks.get(tmp).lexicons) {
