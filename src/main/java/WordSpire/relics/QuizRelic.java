...
import WordSpire.actions.CorrectAction;
import WordSpire.actions.GeneralQuizAction;
import WordSpire.actions.QuizAction;
...
import WordSpire.patches.AbstractPlayerPatch;
import WordSpire.powers.PerfectAnsPower;
import WordSpire.relics.BuildQuizDataRequest.FSRSFactory;
import WordSpire.relics.BuildQuizDataRequest.IFactory;
import WordSpire.savedata.CorrectionNote;
...
public abstract class QuizRelic extends AbstractRelic implements ClickableRelic {
    ...
    public static String toId(BookEnum b) {
        return WordSpireInitializer.JSON_MOD_KEY + b.name() + "_relic";
    }
    ...
    public void triggerQuiz() {
        ...
        BookConfig bookConfig = WordSpireInitializer.allBooks.get(book);
